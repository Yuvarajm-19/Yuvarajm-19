...
### **🎯 OD Claimer Web Application (MERN Stack)**
- **Role-based authentication** (Student/Admin) with JWT security
- **Complete OD request workflow** with approval dashboard
- **Real-time notifications** and status tracking
- **Responsive UI** with admin analytics
...
- **Model training** with various ML algorithms
- **Performance evaluation** and model optimization
- **Prediction APIs** for real-world applications
...
![LeetCode Stats](https://leetcode.card.workers.dev/yuvaraj79043?theme=default&font=source_code_pro&extension=activity)

**Daily DSA Practice | System Design | Algorithm Optimization**
...
🎯 **Actively seeking internships and full-time opportunities in:**
